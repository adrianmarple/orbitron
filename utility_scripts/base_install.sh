...
sudo apt-get update
sudo apt-get install python3-pip python3-numpy python3-scipy libsdl2-2.0 libsdl2-mixer-2.0-0 nodejs npm python3-websockets python3-pygame python3-venv python3-pil i2c-tools libgpiod-dev vim
